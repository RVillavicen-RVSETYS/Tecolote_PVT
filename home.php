					...
					<div class="col-md-4 col-sm-4">
						<div class="card">
							<div class="card-body no-padding">
								...
								$csql = "SELECT COUNT(cgc.idCatCombustible) AS cnt, SUM(cgc.cant) AS suma, MONTH(CURRENT_DATE - INTERVAL 1 MONTH) AS noMes
						...
						<div class="card">
							<div class="card-body no-padding">
								...
								$csql = "SELECT COUNT(cgc.idCatCombustible) AS cnt, SUM(cgc.cant) AS suma, MONTH(CURRENT_DATE - INTERVAL 1 MONTH) AS noMes
														...
														AND  
														DATE_FORMAT(cgc.fechaReg,'%m-%Y') =DATE_FORMAT(CURRENT_DATE - INTERVAL 1 MONTH,'%m-%Y')
					...
					<div class="col-md-12">
						<div class="card ">
							...
							while ($abc = mysqli_fetch_array($vres)) {
								$vnt = ($abc['vtasPagadas'] == '' || empty($abc['vtasPagadas'])) ? 0 : $abc['vtasPagadas'];
								$Vjs = ($abc['vtasTerminadas'] == '' || empty($abc['vtasTerminadas'])) ? 0 : $abc['vtasTerminadas'];
					...
					<div class="col-md-12">
						<div class="card ">
							...
							while ($abc2 = mysqli_fetch_array($vres2)) {
								$vnt2 = ($abc2['vtasPagadas'] == '' || empty($abc2['vtasPagadas'])) ? 0 : $abc2['vtasPagadas'];
								$Vjs2 = ($abc2['vtasTerminadas'] == '' || empty($abc2['vtasPagadas'])) ? 0 : $abc2['vtasTerminadas'];
		...
		<div class="modal fade" id="modalDiesel2" tabindex="-1" role="dialog" aria-labelledby="modalDieselLabel2" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="modalDieselLabel2">Desgloce del Mes Ant. de Diésel</h4>
					</div>
		...
		<div class="modal fade" id="modalMagna2" tabindex="-1" role="dialog" aria-labelledby="modalMagnaLabel2" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="modalMagnaLabel2">Desgloce del Mes Ant. de Magna</h4>
					</div>
		...
		<div class="modal fade" id="modalPremium2" tabindex="-1" role="dialog" aria-labelledby="modalPremiumLabel2" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="modalDieselLabel2">Desgloce del Mes Ant. de Premium</h4>
					</div>
