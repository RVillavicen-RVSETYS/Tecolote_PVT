								...
								<!-- BEGIN ACTION -->
										<div class="card card-bordered style-primary">
											<div class="card-head">
												...
												<header><i class="fa fa-fw fa-wrench"></i> Mantenimientos</header>
											</div><!--end .card-head -->
											<div class="card-body style-default-bright">
												<table class="table no-margin table-hover">
													...
													<tbody>
														<tr class="">
															...
															<td class="text-right">
																<button type="button" class="btn btn-icon-toggle" data-toggle="modal" data-target="#formModal" data-original-title="Edit row"><i class="fa fa-pencil"></i></button>
															</td>
														</tr>
													</tbody>
												</table>
												...
												<form class="form" role="form">
													<div class="form-group floating-label col-lg-8">
														<input type="text" class="form-control" id="newTipoMtto" name="newTipoMtto">
														<label for="regular2">Nombre del Mantenimiento</label>
													</div>
													<div class="col-lg-4 text-center">
														<button type="button" class="btn ink-reaction btn-raised btn-primary btn-loading-state" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Cargando...">Agregar</button>
													</div>
												</form>
											</div>
											</div><!--end .card-body -->
						...
						<form class="form-horizontal" role="form">
							<div class="modal-body">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="nombre" name="nombre" id="nomTipoMtto" class="form-control" placeholder="Nombre del Mantenimiento">
									</div>
								</div>
							</div>
