...
<html lang="es">
	...
	<body class="menubar-hoverable header-fixed me">
		...
		<div id="base">
								...
								<!-- BEGIN ACTION -->
										<div class="card card-bordered style-primary">
											<div class="card-head">
												...
												<header><i class="fa fa-fw fa-bank"></i> Bancos</header>
											</div><!--end .card-head -->
											<div class="card-body style-default-bright">
													...
													<tbody>
														...
														while ($dat = mysqli_fetch_array($res)) {
															...
															<tr class="">
																...
																<td>'.$dat['nombre'].'</td>
																<td class="text-right">
																	<button type="button" class="btn btn-icon-toggle" onclick="formEditBanco('.$dat['id'].')" data-toggle="modal" data-target="#formEditBanco"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" data-original-title="Editar Registro"></i></button>
																</td>
															</tr>';
														}
														?>
												...
												<div class="col-lg-12">
													<form class="form" role="form" action="../funciones/registraNuevoCatBanco.php" method="post">
														<div class="form-group floating-label col-lg-8">
															<input type="text" class="form-control" id="newBanco" name="nombre">
															<label for="newBanco">Nombre del Banco</label>
														</div>
			...
			<div class="modal fade" id="formEditBanco" tabindex="-1" role="dialog" aria-labelledby="formEditBancoLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content" id="editaBancoContent">
					</div><!-- /.modal-content -->
				</div><!-- /.modal-dialog -->
			</div><!-- /.modal -->
		...
		$( document ).ready(function() {
			<?php
			if (isset( $_SESSION['ATZmsjAdminBancos'])) {
				echo "notificaBad('".$_SESSION['ATZmsjAdminBancos']."');";
				unset($_SESSION['ATZmsjAdminBancos']);
			}
			if (isset( $_SESSION['ATZmsjSuccesAdminBancos'])) {
				echo "notificaSuc('".$_SESSION['ATZmsjSuccesAdminBancos']."');";
				unset($_SESSION['ATZmsjSuccesAdminBancos']);
			}
			?>
		});

		function formEditBanco(ident){
			$("#editaBancoBody").html('<span class="text-default"><img src="../assets/img/loading.gif" class="img-responsive" style="margin-bottom:-1em" alt="Cargando..."/></span>');
			//alert('ID: '+ident);
			$.post("../funciones/formEditaBanco.php",
				{ ident:ident, pag:'<?=$info->pagina;?>' },
					function(respuesta){
						$("#editaBancoContent").html(respuesta);
					});
		}
