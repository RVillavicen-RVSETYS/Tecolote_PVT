...
if (mysqli_num_rows($result) == 0) {
  echo '
    <tr>
      <td class="text-center" colspan="3">No ha registrado ningúna Contacto a esta Marca.</td>
    </tr>';
}
...
function editaContacto(ident){
  $.post("../funciones/formEditaContactoProveedores.php",
    { ident:ident},
      function(respuesta){
...
// function enviaID(){
  //value = $("#identCliente").val();
  //$.post("../Encargado/clientes.php",
    //{ valorCliente:value}
      //);
//}
</script>
