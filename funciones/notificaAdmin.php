...
?>
  ...
  $sqlPoliza = "SELECT COUNT(id) AS cant FROM polizas WHERE fechaVence BETWEEN '$fechaAct' AND '$fechaBusqueda' AND estatus = '1'";
  ...
  $sqlPoliza2 = "SELECT ase.nombre,COUNT(plz.id) AS cantPolizas
                  ...
                  WHERE plz.fechaVence BETWEEN '$fechaAct' AND '$fechaBusqueda' AND plz.estatus = '1'
