...
$sql="SELECT * FROM aseguradoras WHERE id='$id'";
...
<html lang="es">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title txt-primary" id="editaDeptoLabel"><b>Editar Aseguradora: </b><?=$dat['nombre'];?></h4>
  </div>
  <form class="form-horizontal" role="form" method="post" action="../funciones/editaAseguradoras.php" >
    <div class="modal-body" id="editaCatTipoMttoBody">
      ...
      <div class="form-group">
        <div class="col-sm-3">
          <label for="noEmergencia" class="control-label">No. Emergencia</label>
        </div>
        <div class="col-sm-9">
          <input type="text" name="noEmergencia" id="noEmergencia" class="form-control" placeholder="Numero de Emergencia" value="<?=$dat['noEmergencia'];?>" required>
        </div>
      </div>
  ...
  <script src="../assets/js/libs/fileInput/fileinput.min.js"></script>
