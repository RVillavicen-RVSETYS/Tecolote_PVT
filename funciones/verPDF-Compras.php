...
#print_r($_POST);
$sql="SELECT fa.doctoComprobante,fa.urlPDF,cmp.doctoComprobante AS cmpComprueba
FROM compras cmp
LEFT JOIN facturas fa on cmp.doctoFactura = fa.id
 WHERE cmp.id ='$id'";
#echo $sql;
...
$comprueba = ($documentos['cmpComprueba'] == '') ? $documentos['doctoComprobante'] : $documentos['cmpComprueba'] ;
$pdf = ($documentos['urlPDF'] == '') ? $comprueba : $documentos['urlPDF'] ;
