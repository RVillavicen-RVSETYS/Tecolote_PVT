...
$resPoliza = mysqli_query($link,$sqlPoliza) or die ('<p class="text-danger">Problemas al consultar las pólizas, Notifica a tu Administrador</p>');
#echo $sqlPoliza;
...
$resPoliza2 = mysqli_query($link,$sqlPoliza2) or die ('<p class="text-danger">Problemas al consultar loas pólizas, Notifica a tu Administrador</p>'.mysqli_error($link));
