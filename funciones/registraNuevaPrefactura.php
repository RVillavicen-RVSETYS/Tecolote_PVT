...
$descripcion = 'Cobro de los viajes: '.substr($cadena,0,-1).".";;
#echo 'descripcion: '.$descripcion.'<br>';
if ($contador < 1) {
  $sql1="INSERT INTO prefactura (fecha, descripcion, nota, idUserReg, estatus, fechaReg) VALUES (now(),'$descripcion','$nota','$userReg','1',Now())";
...
$squery="UPDATE ventas SET idPrefactura = '$idPreFac' WHERE id IN ($muestra)";
...
$_SESSION['ATZmsjSuccesAdminPreFacturaCliente'] = 'La PreFactura se a creado Corrrectamente.';
