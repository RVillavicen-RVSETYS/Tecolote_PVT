...
$sql="SELECT * FROM cattipovehiculos WHERE id='$id'";
...
<html lang="es">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title txt-primary" id="editaDeptoLabel"><b>Editar Tipo de Vehiculo: </b><?=$dat['nombre'];?></h4>
  </div>
  <form class="form-horizontal" role="form" method="post" action="../funciones/editaCatTipoVehiculo.php" >
    <div class="modal-body" id="editaTipoVehiculoBody">
