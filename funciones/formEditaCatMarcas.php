...
$sql="SELECT * FROM catmarcas WHERE id='$id'";
...
<html lang="es">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="../assets/css/theme-2/upload.css" />
		<link type="text/css" rel="stylesheet" href="../assets/css/theme-2/fileinput.css" />

  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 class="modal-title txt-primary" id="editaDeptoLabel"><b>Editar Marca: </b><?=$dat['nombre'];?></h4>
  </div>
  <form class="form-horizontal" role="form" method="post" action="../funciones/editaCatMarcas.php" >
    <div class="modal-body" id="editaMarcaBody">
