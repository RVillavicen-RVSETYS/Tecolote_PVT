...
$sql = "INSERT INTO vehiculos(noEconomico, idCatMarca, idCatSubmarca, modelo, noMotor, idPoliza, idCatCombustible, capacidadLts, kilometros, idCatTipoVehiculo, placas, serie, tag, idUserReg, fechaReg, fechaVerificacion)
      VALUES('$noeco', '$marca', '$idCatSubmarca', '$modelo', '$noMotor', '$poliza', '$combustible', '$capLts', '$kmts', '$tipo', '$placas', '$serie', '$tag', '$userReg', NOW(), '$fechaVeri')";
//echo '<br>SQL: '.$sql.'<br>';
