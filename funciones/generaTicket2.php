...
/*
 ...
 # */
  ...
  echo '<tr>
        ...
        <tr><td colspan="2" style="font-size:16px">Odómetro Actual: </td><td>'.number_format($odometroActual,2,'.',',').' KM</td></tr>
        <tr><td colspan="2" style="font-size:16px">Odómetro Anterior: </td><td>'.number_format($odometroAnterior,2,'.',',').' KM</td></tr>
