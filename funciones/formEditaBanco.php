...
$sql="SELECT * FROM catbancos WHERE id='$id'";
...
?>
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="editaBancoLabel"><b>Editar Banco: </b><?=$dat['nombre'];?></h4>
  </div>
  <form class="form-horizontal" role="form" method="post" action="../funciones/editaBanco.php">
