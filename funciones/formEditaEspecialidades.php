...
$sql="SELECT * FROM catespecialidades WHERE id='$id'";
...
?>
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title" id="editaEspecialidadesLabel"><b>Editar Especialidad: </b><?=$dat['nombre'];?></h4>
  </div>
  <form class="form-horizontal" role="form" method="post" action="../funciones/editaEspecialidades.php">
    <div class="modal-body" id="editaEspecialidadesBody">
