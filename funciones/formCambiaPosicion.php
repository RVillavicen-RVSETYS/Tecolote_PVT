  ...
  <form class="form-horizontal" role="form" method="post" action="../funciones/cambiaPosicion.php">
    <div class="modal-body" id="editaPosicionBody">
      ...
      <div class="form-group">
        <div class="col-sm-3">
          <label for="depto" class="control-label">Posición Actual</label>
        </div>
        <div class="col-sm-9">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <select name="posicion" id="posicion" class="form-control" placeholder="Selecciona una Posición" style="font-size: 1.12em" required>
            <?=$muestraPosicion;?>
         </select>
        </div>
      </div>
