...
<html lang="es">
  ...
  <form class="form-horizontal" role="form" method="post" action="../funciones/editaContactos.php" >
    <div class="modal-body" id="editaContactoBody">
        ...
        <div class="col-sm-9">
          <input type="text" name="tel" id="tel" class="form-control" placeholder="Tel. Oficina" value="<?=$dat['telOf'];?>" required>
        </div>
      </div>
			<div class="form-group">
        <div class="col-sm-3">
