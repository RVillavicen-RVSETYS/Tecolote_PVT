...
$sql="SELECT vhc.id AS idVehiculo, vhc.noEconomico AS noEco, vhc.placas AS vePlacas, cmk.nombre AS nomMarca, csmk.nombre AS nomSubMarca, ctv.nombre AS nomTipo,
      ...
      vhc.idCatMarca AS catMarca, vhc.idCatSubmarca AS catSubMarca, vhc.modelo AS veModelo, vhc.serie AS veSerie, vhc.idCatTipoVehiculo AS idTipo,vhc.tag AS veTag
      FROM vehiculos vhc
