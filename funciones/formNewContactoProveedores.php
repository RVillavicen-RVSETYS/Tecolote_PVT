...
<html lang="es">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title txt-primary" id="newContactoLabel"><b>Crear Contacto: </b></h4>
  </div>
  <form class="form-horizontal" role="form" method="post" action="../funciones/registraNuevoContactoProveedores.php" >
    <div class="modal-body" id="newContactoBody">
        ...
        <div class="col-sm-9">
          <input type="text" name="newnombre" id="nombre" class="form-control" placeholder="Nombre" required>
			...
			<div class="form-group">
        <div class="col-sm-3">
          <label for="tel" class="control-label">Tel. Oficina</label>
        </div>
        <div class="col-sm-9">
          <input type="text" name="newtel" id="tel" class="form-control" placeholder="Tel. Oficina" required>
        </div>
      </div>
			<div class="form-group">
        <div class="col-sm-3">
        ...
        <div class="col-sm-9">
          <input type="text" name="newcel" id="cel" class="form-control" placeholder="Celular" required>
        </div>
      </div>
        ...
        <div class="col-sm-9">
          <input type="text" name="newcorreo" id="correo" class="form-control" placeholder="Correo" required>
        </div>
      </div>

    </div>
    <div class="modal-footer">
			<input type="hidden" name="newident" value="<?=$ident;?>">
			<input type="hidden" name="newtabla" value="<?=$tabla;?>">
