...
<html lang="es">
  ...
  <div class="modal-header">
    ...
    <h4 class="modal-title txt-primary" id="editaContactoLabel"><b>Editar Contacto: </b><?=$dat['nombre'];?></h4>
  </div>
  <form class="form-horizontal" role="form" method="post" action="../funciones/editaContactosProveedores.php" >
    <div class="modal-body" id="editaContactoBody">
        ...
        <div class="col-sm-9">
          <input type="number" name="tel" id="tel" class="form-control" placeholder="Tel. Oficina" value="<?=$dat['telOf'];?>" required>
        </div>
      </div>
			<div class="form-group">
        <div class="col-sm-3">
        ...
        <div class="col-sm-9">
          <input type="text" name="cel" id="cel" class="form-control" placeholder="Celular" value="<?=$dat['cel'];?>" required>
        </div>
      </div>
        ...
        <div class="col-sm-9">
          <input type="text" name="correo" id="correo" class="form-control" placeholder="Correo" value="<?=$dat['correo'];?>" required>
        </div>
      </div>
