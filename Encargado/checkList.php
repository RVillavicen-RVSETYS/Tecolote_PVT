			...
			<div id="content">
				<section>
					<div class="section-body">
						...
						<!-- END INTRO -->
						<div class="col-sm-2">
							<label for="Vehiculo" class="control-label">Selecciona un Vehículo</label>
						</div>
						<?php
						require('../include/connect.php');
						...
						<div class="col-md-12">
							<div class="card card-bordered style-primary">
								<div class="card-head">
									...
									<header><i class="fa fa-fw fa-tag"></i> Datos del Vehículo</header>
								</div><!--end .card-head -->
										...
										<form class="form" role="form" method="post" action="../funciones/registraDescripcion.php">
											...
											<div class="row">
												<div class="modal-header">
													<h4 class="modal-title" id="formNewUserLabel"><b>Agregar Descripción</b></h4>
												</div>
												<div class="col-sm-1">
