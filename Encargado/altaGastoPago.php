...
$descripcionGasto = (isset($_POST['dGasto'])) ? $_POST['dGasto'] : '' ;
...
$descripcionPago = (isset($_POST['dPago'])) ? $_POST['dPago'] : '' ;
...
#  errorBD('Hay un Error debes ingresar <b>Todos los campos</b>, intentalo de Nuevo.');
#}
...
header('location: ../gastos.php');
  ...
  $sql2="SELECT v.*, dv.id AS dViaje
        ...
        $dPago = $d["dViaje"];
        print_r($dPago);
$sql2="INSERT INTO gastosextra (idViaje,idDetalleViaje,tipo,descripcion,punto,monto,estatus,idUserReg,fechaReg) VALUES ('$viajePago','$dPago','1','$descripcionPago','$puntoPago','$precioPago','1','$userReg',NOW())";
//echo $sql;
