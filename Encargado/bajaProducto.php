...
<body class="menubar-hoverable header-fixed me">
	...
	<div id="base">
				...
				<section>
					<div class="section-body">
						...
						<div class="row">
							...
							?>
							<div class="col-md-12">
								<div class="card card-bordered style-primary card-underline" id="cardBajas">
									<div class="card-head">
										<div class="tools">
											<?php
										  require('../include/connect.php');
										  ...
										  ?>
											<div class="btn-group" id="seleccionaOperador" data-toggle="popover" data-placement="top" data-content="Por favor selecciona un Operador para Comenzar." data-original-title="" title="Atención!">
													<select name="usuAsigna" id="opAsigna" class="btn ink-reaction btn-flat dropdown-toggle" onchange="listaDeArticulos(this.value)">
													<?php
										...
										<header><i class="fa fa-fw"></i>Bajas</header>
									</div><!--end .card-head -->
									<div class="card-body style-default-bright">
										<form class="form" method="post" action="../funciones/capturaBaja.php">
											<div id="Bajas" class="card-body style-default-bright table-responsive">
											</div>
											<div class="col-md-6 offset-md-2 txt-Right table-responsive" style="vertical-align: baseline;">
												<center><br><br>
													<textarea id="descBaja" name="descBaja"  cols="50" placeholder=" Ingresa la Descripción" required></textarea>
												</center>
											</div>
											<div class="col-md-3 txt-Right" style="vertical-align: baseline;">
												<center><br><br>
													<button type="submit" class="btn ink-reaction btn-raised btn-primary btn-loading-state" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Cargando...">Dar de Baja</button>
												</center>
											</div>
									</form>
									</div><!--end .card-body -->
		...
		$(document).ready(function(){
			<?php
			if (isset( $_SESSION['ATZmsjBajaDeArticulos'])) {
				echo "notificaBad('".$_SESSION['ATZmsjBajaDeArticulos']."');";
				unset($_SESSION['ATZmsjBajaDeArticulos']);
			}
			if (isset( $_SESSION['ATZmsjSuccessBajaDeArticulos'])) {
				echo "notificaSuc('".$_SESSION['ATZmsjSuccessBajaDeArticulos']."');";
				unset($_SESSION['ATZmsjSuccessBajaDeArticulos']);
			}
			?>
	  });
...
function listaDeArticulos(ident){
	$.post("../funciones/listarAsignacionesParaBaja.php",
			{ident:ident},
				function(respuesta){
				$("#Bajas").html(respuesta);
			});
	}
