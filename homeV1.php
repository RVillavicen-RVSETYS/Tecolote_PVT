							...
							<div class="col-md-4 col-sm-4">
								<div class="card">
									<div class="card-body no-padding">
										...
										$debug = 0;
										$fechaAct=date('Y-m-d');
										$miFecha = strtotime ( '-3 day' , strtotime ( $fechaAct ) ) ;
										 $fechaMenos3 = date ( 'Y-m-d' , $miFecha );

										$sqlActualiza = "UPDATE polizas SET estatus = '2' WHERE fechaVence BETWEEN '$fechaMenos3' AND '$fechaAct'";
										$resSqlActualiza = mysqli_query($link,$sqlActualiza) or die('<p class="text-danger">Problemas al actualizar las pólizas, Notifica a tu Administrador</p>');

										$sqlActualiza2 = "UPDATE polizas SET estatus = '3' WHERE fechaVence < '$fechaMenos3'";
										#echo $sqlActualiza2;
										$resSqlActualiza2 = mysqli_query($link,$sqlActualiza2) or die('<p class="text-danger">Problemas al actualizar las pólizas, Notifica a tu Administrador</p>');
										...
										$csql=" SELECT COUNT(cgc.idCatCombustible) AS cnt, SUM(cgc.cant) AS suma, (MONTH(NOW())-1) AS noMes
														...
														WHERE cgc.idCatCombustible = '3' AND MONTH(cgc.fechaReg) = (MONTH(NOW())-1)
										...
										switch ($cargaGas['noMes']){
											case '1':			$mes='Diésel Entregado en <strong>Enero</strong>';							break;
											case '2':			$mes='Diésel Entregado en <strong>Febrero</strong>';						break;
											case '3':			$mes='Diésel Entregado en <strong>Marzo</strong>';							break;
											case '4':			$mes='Diésel Entregado en <strong>Abril</strong>';							break;
											case '5':			$mes='Diésel Entregado en <strong>Mayo</strong>';								break;
											case '6':			$mes='Diésel Entregado en <strong>Junio</strong>';							break;
											case '7':			$mes='Diésel Entregado en <strong>Julio</strong>';							break;
											case '8':			$mes='Diésel Entregado en <strong>Agosto</strong>';							break;
											case '9':			$mes='Diésel Entregado en <strong>Septiembre</strong>';					break;
											case '10':		$mes='Diésel Entregado en <strong>Octubre</strong>';						break;
											case '11':		$mes='Diésel Entregado en <strong>Noviembre</strong>';					break;
											case '12':		$mes='Diésel Entregado en <strong>Diciembre</strong>';					break;
										...
										<div class="no-margin">
											...
											<span class="opacity-50"><br>&nbsp;&nbsp;<?=$mes;?></span>
										</div>
									</div><!--end .card-body -->
								</div><!--end .card -->
							</div><!--end .col -->
								...
								<div class="card">
									<div class="card-body no-padding">
										...
										$csql=" SELECT COUNT(cgc.idCatCombustible) AS cnt, SUM(cgc.cant) AS suma, (MONTH(NOW())-1) AS noMes
														FROM cargacombustible cgc
														INNER JOIN catcombustibles ctc ON ctc.id = cgc.idCatCombustible
														WHERE cgc.idCatCombustible = '2' AND MONTH(cgc.fechaReg) = (MONTH(NOW())-1)
														GROUP BY cgc.idCatCombustible
										";
										$res=mysqli_query($link,$csql) OR DIE ('<p class="text-danger">Notifica a tu Administrador</p>');
										$cargaGas = mysqli_fetch_array($res);
										switch ($cargaGas['noMes']){
											case '1':			$mes='Gasolina Entregada en <strong>Enero</strong>';							break;
											case '2':			$mes='Gasolina Entregada en <strong>Febrero</strong>';						break;
											case '3':			$mes='Gasolina Entregada en <strong>Marzo</strong>';							break;
											case '4':			$mes='Gasolina Entregada en <strong>Abril</strong>';							break;
											case '5':			$mes='Gasolina Entregada en <strong>Mayo</strong>';							break;
											case '6':			$mes='Gasolina Entregada en <strong>Junio</strong>';							break;
											case '7':			$mes='Gasolina Entregada en <strong>Julio</strong>';							break;
											case '8':			$mes='Gasolina Entregada en <strong>Agosto</strong>';						break;
											case '9':			$mes='Gasolina Entregada en <strong>Septiembre</strong>';				break;
											case '10':		$mes='Gasolina Entregada en <strong>Octubre</strong>';						break;
											case '11':		$mes='Gasolina Entregada en <strong>Noviembre</strong>';					break;
											case '12':		$mes='Gasolina Entregada en <strong>Diciembre</strong>';					break;
								...
								<div class="card">
									<div class="card-body no-padding">
										...
										$csql=" SELECT COUNT(cgc.idCatCombustible) AS cnt, SUM(cgc.cant) AS suma, (MONTH(NOW())-1) AS noMes
														FROM cargacombustible cgc
														INNER JOIN catcombustibles ctc ON ctc.id = cgc.idCatCombustible
														WHERE cgc.idCatCombustible = '1' AND MONTH(cgc.fechaReg) = (MONTH(NOW())-1)
														GROUP BY cgc.idCatCombustible
										";
										$res=mysqli_query($link,$csql) OR DIE ('<p class="text-danger">Notifica a tu Administrador</p>');
										$cargaGas = mysqli_fetch_array($res);
					...
					<div class="row">
							...
							<div class="col-md-3 col-sm-4">
								<div class="card">
									...
									switch ($cargaGas['noMes']){
										case '1':			$pmes='Productos Faltantes en el mes: <strong>Enero</strong>';							break;
										case '2':			$pmes='Productos Faltantes en el mes: <strong>Febrero</strong>';						break;
										case '3':			$pmes='Productos Faltantes en el mes: <strong>Marzo</strong>';							break;
										case '4':			$pmes='Productos Faltantes en el mes:  <strong>Abril</strong>';							break;
										case '5':			$pmes='Productos Faltantes en el mes:  <strong>Mayo</strong>';							break;
										case '6':			$pmes='Productos Faltantes en el mes:  <strong>Junio</strong>';							break;
										case '7':			$pmes='Productos Faltantes en el mes:  <strong>Julio</strong>';							break;
										case '8':			$pmes='Productos Faltantes en el mes:  <strong>Agosto</strong>';						break;
										case '9':			$pmes='Productos Faltantes en el mes:  <strong>Septiembre</strong>';				break;
										case '10':		$pmes='Productos Faltantes en el mes:  <strong>Octubre</strong>';						break;
										case '11':		$pmes='Productos Faltantes en el mes:  <strong>Noviembre</strong>';					break;
										case '12':		$pmes='Productos Faltantes en el mes:  <strong>Diciembre</strong>';					break;
									...
									<div class="card-body no-padding">
										<div class="alert alert-callout alert-info no-margin  text-right">
											...
											<h4 class="text-xl"><?=$productos;?></h4></button>
								...
								<div class="card">
									<div class="card-body no-padding">
										...
										$csql=" SELECT COUNT(cgc.idCatCombustible) AS cnt, SUM(cgc.cant) AS suma, MONTH(NOW()) AS noMes
														FROM cargacombustible cgc
														INNER JOIN catcombustibles ctc ON ctc.id = cgc.idCatCombustible
														WHERE cgc.idCatCombustible = '3' AND MONTH(cgc.fechaReg) = MONTH(NOW())
														GROUP BY cgc.idCatCombustible";
										$res=mysqli_query($link,$csql) OR DIE ('<p class="text-danger">Notifica a tu Administrador</p>');
										$cargaGas = mysqli_fetch_array($res);
										switch ($cargaGas['noMes']){
								...
								<div class="card">
									<div class="card-body no-padding">
										...
										$csql=" SELECT COUNT(cgc.idCatCombustible) AS cnt, SUM(cgc.cant) AS suma, MONTH(NOW()) AS noMes
														FROM cargacombustible cgc
														INNER JOIN catcombustibles ctc ON ctc.id = cgc.idCatCombustible
														WHERE cgc.idCatCombustible = '2' AND MONTH(cgc.fechaReg) = MONTH(NOW())
														GROUP BY cgc.idCatCombustible
										";
										$res=mysqli_query($link,$csql) OR DIE ('<p class="text-danger">Notifica a tu Administrador</p>');
										$cargaGas = mysqli_fetch_array($res);
								...
								<div class="card">
									<div class="card-body no-padding">
										...
										$csql=" SELECT COUNT(cgc.idCatCombustible) AS cnt, SUM(cgc.cant) AS suma, MONTH(NOW()) AS noMes
														FROM cargacombustible cgc
														INNER JOIN catcombustibles ctc ON ctc.id = cgc.idCatCombustible
														WHERE cgc.idCatCombustible = '1' AND MONTH(cgc.fechaReg) = MONTH(NOW())
														GROUP BY cgc.idCatCombustible
										";
										$res=mysqli_query($link,$csql) OR DIE ('<p class="text-danger">Notifica a tu Administrador</p>');
										$cargaGas = mysqli_fetch_array($res);
								...
								<div class="col-md-12">
									<div class="card ">
												...
												$vsql = "SELECT * FROM ((SELECT IF (vtsPgds.diap IS NULL, vjsTrm.diat, vtsPgds.diap) AS fechaAct,
																...
																FROM ventas vts WHERE vts.estatusPago = 2 AND MONTH (vts.fechaCarga) = MONTH (NOW())
																...
																FROM ventas vjs
																WHERE vjs.estatusViaje = 3 AND MONTH (vjs.fechaEntrega) = MONTH (NOW())
																...
																FROM (SELECT vts.fechaCarga AS diap, COUNT(vts.estatusPago) AS vtasPagadas
																FROM ventas vts
																WHERE vts.estatusPago = 2 AND MONTH (vts.fechaCarga) = MONTH (NOW())
								...
								<div class="col-md-12">
									<div class="card ">
												...
												$vsql2 = "SELECT * FROM ((SELECT IF (vtsPgds.diap IS NULL, vjsTrm.diat, vtsPgds.diap) AS fechaAct,
																 vtsPgds.vtasPagadas, vjsTrm.vtasTerminadas
																FROM (SELECT vts.fechaCarga AS diap, COUNT(vts.estatusPago) AS vtasPagadas
																FROM ventas vts WHERE vts.estatusPago = 2 AND MONTH (vts.fechaCarga) = (MONTH (NOW())-1)
																GROUP BY vts.fechaCarga ORDER BY vts.fechaCarga ASC) vtsPgds
																LEFT JOIN ((SELECT vjs.fechaEntrega AS diat, COUNT(vjs.estatusViaje) AS vtasTerminadas
																FROM ventas vjs
																WHERE vjs.estatusViaje = 3 AND MONTH (vjs.fechaEntrega) = (MONTH (NOW())-1)
																GROUP BY vjs.fechaEntrega
																ORDER BY vjs.fechaEntrega ASC)) vjsTrm ON vtsPgds.diap = vjsTrm.diat )
																UNION
																(SELECT IF (vtsPgds.diap IS NULL, vjsTrm.diat, vtsPgds.diap) AS fechaAct,
																...
																FROM (SELECT vts.fechaCarga AS diap, COUNT(vts.estatusPago) AS vtasPagadas
																FROM ventas vts
																WHERE vts.estatusPago = 2 AND MONTH (vts.fechaCarga) = (MONTH (NOW())-1)
																GROUP BY vts.fechaCarga
																ORDER BY vts.fechaCarga ASC) vtsPgds
																RIGHT JOIN ((SELECT vjs.fechaEntrega AS diat, COUNT(vjs.estatusViaje) AS vtasTerminadas
																FROM ventas vjs
							...
							<?php
								...
								$dsql="SELECT CONCAT('ECO - ',ve.noEconomico,' PLACAS: ',ve.placas,' (',op.nombre,' ',op.apellidos,')') AS nVe, SUM(carco.cant) AS lts
											,COUNT(vjs.id) AS cantViajes
																...
																WHERE catco.id = 3 AND MONTH(carco.fechaReg) = MONTH(NOW())
																GROUP BY op.id
								...
								<table id="datatable1" class="table table-striped table-hover">
									<thead>
										<tr>
											<th>#</th>
											<th>Vehículo</th>
											<th class="text-center">Litros Entregados</th>
									...
									<tbody>
										...
										while ($ddat = mysqli_fetch_array($dres)) {
											...
											<tr>
												<td>'.++$cont.'</td>
												<td>'.$ddat['nVe'].'</td>
												<td class="text-center">'.$ddat['lts'].'</td>
												<td class="text-center">'.$ddat['cantViajes'].'</td>
											</tr>';
										}
										?>
									</tbody>
							...
							<?php
								...
								$msql="SELECT CONCAT('ECO - ',ve.noEconomico,' PLACAS: ',ve.placas,' (',op.nombre,' ',op.apellidos,')') AS nVe, SUM(carco.cant) AS lts,
											COUNT(vjs.id) AS cantViajes
																...
																INNER JOIN operadores op ON op.id = asgv.idOperador
																INNER JOIN vehiculos ve ON ve.id = asgv.idVehiculo
																WHERE catco.id = 2 AND MONTH(carco.fechaReg) = MONTH(NOW())
																GROUP BY op.id
																ORDER BY carco.idGasolinera ASC";
							...
							<?php
								...
								$psql="SELECT CONCAT('ECO - ',ve.noEconomico,' PLACAS: ',ve.placas,' (',op.nombre,' ',op.apellidos,')') AS nVe, SUM(carco.cant) AS lts,
											COUNT(vjs.id) AS cantViajes
																...
																INNER JOIN operadores op ON op.id = asgv.idOperador
																INNER JOIN vehiculos ve ON ve.id = asgv.idVehiculo
																WHERE catco.id = 1 AND MONTH(carco.fechaReg) = MONTH(NOW())
																GROUP BY op.id
																ORDER BY carco.idGasolinera ASC";
							...
							<?php
								...
								$dsql="SELECT CONCAT('ECO - ',ve.noEconomico,' PLACAS: ',ve.placas,' (',op.nombre,' ',op.apellidos,')') AS nVe, SUM(carco.cant) AS lts,
											COUNT(vjs.id) AS cantViajes
																...
																INNER JOIN operadores op ON op.id = asgv.idOperador
																INNER JOIN vehiculos ve ON ve.id = asgv.idVehiculo
																WHERE catco.id = 3 AND MONTH(carco.fechaReg) = (MONTH(NOW())-1)
																GROUP BY op.id
																ORDER BY carco.idGasolinera ASC";
								$dres = mysqli_query($link,$dsql) or die('<p class="text-danger">Notifica al Administrador de este Problema.</p>');
							?>
							...
							<?php
								...
								$msql="SELECT CONCAT('ECO - ',ve.noEconomico,' PLACAS: ',ve.placas,' (',op.nombre,' ',op.apellidos,')') AS nVe, SUM(carco.cant) AS lts,
											COUNT(vjs.id) AS cantViajes
																...
																INNER JOIN operadores op ON op.id = asgv.idOperador
																INNER JOIN vehiculos ve ON ve.id = asgv.idVehiculo
																WHERE catco.id = 2 AND MONTH(carco.fechaReg) = (MONTH(NOW())-1)
																GROUP BY op.id
																ORDER BY carco.idGasolinera ASC";
								$mres = mysqli_query($link,$msql) or die('<p class="text-danger">Notifica al Administrador de este Problema.</p>');
							?>
							...
							<?php
								...
								$psql="SELECT CONCAT('ECO - ',ve.noEconomico,' PLACAS: ',ve.placas,' (',op.nombre,' ',op.apellidos,')') AS nVe, SUM(carco.cant) AS lts,
											COUNT(vjs.id) AS cantViajes
																...
																INNER JOIN operadores op ON op.id = asgv.idOperador
																INNER JOIN vehiculos ve ON ve.id = asgv.idVehiculo
																WHERE catco.id = 1 AND MONTH(carco.fechaReg) = (MONTH(NOW())-1)
																GROUP BY op.id
																ORDER BY carco.idGasolinera ASC";
								$pres = mysqli_query($link,$psql) or die('<p class="text-danger">Notifica al Administrador de este Problema.</p>');
							?>
